...
//                .baseUrl("http://" + System.getProperty("host") + ":" + System.getProperty("port") + "/")
    ...
    public void getClusterTagsWithClustersInfo(String clusterId, ServiceCallback callback) {
        Call<JsonNode> call = apiService.getClusterTagsWithClustersInfo(clusterId);
        call.enqueue(new JsonCallback(callback));
    }
