...
public class WaypointAdapter extends ArrayAdapter<SearchListItem> {
    private List<SearchListItem> tagListFull;

    public WaypointAdapter(@NonNull Context context, @NonNull List<SearchListItem> tagList) {
    ...
    public List<SearchListItem> getTagListFull() {
        return tagListFull;
    }
